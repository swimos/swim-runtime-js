...
/** @hidden */
export function ScaleTransformInterpolator(f0: ScaleTransform, f1: ScaleTransform): Interpolator<ScaleTransform> {
...
__extends(ScaleTransformInterpolator, Interpolator);
