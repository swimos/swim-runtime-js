...
import {LinearCurveR2Parser} from "../curve/LinearCurveR2Parser";
import {QuadraticCurveR2Parser} from "../curve/QuadraticCurveR2Parser";
import {CubicCurveR2Parser} from "../curve/CubicCurveR2Parser";
import {EllipticCurveR2Parser} from "../curve/EllipticCurveR2Parser";
        ...
        if (curveParser === void 0) {
          ...
          if (input.isCont()) {
            ...
            switch (c) {
              ...
              case 86/*'V'*/:
              case 118/*'v'*/:
                curveParser = LinearCurveR2Parser.parse(input, xParser, yParser);
                command = c;
                break;
              case 81/*'Q'*/:
              case 113/*'q'*/:
              ...
              case 122/*'z'*/:
                ...
                curves.push(new LinearCurveR2(xParser!.bind(), yParser!.bind(),
              ...
              case 57/*'9'*/:
                switch (command) {
                  ...
                  case 86/*'V'*/:
                  case 118/*'v'*/:
                    curveParser = LinearCurveR2Parser.parseRest(input, command, xParser, yParser);
                    break;
                  case 81/*'Q'*/:
                  case 113/*'q'*/:
