...
export declare abstract class LinearDomain {
  declare readonly 0: number;

  declare readonly 1: number;

  get inverse(): LinearRange;
...
export function LinearDomain(x0: number, x1: number): LinearDomain {
